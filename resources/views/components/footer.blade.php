        ...
        <div class="flex flex-wrap mx-[-12px]">
            ...
            <div class="xl:w-3/12 lg:w-3/12 md:w-3/12 sm:w-6/12 flex-[0_0_auto] max-w-full px-[12px]">
                <div class="footer-widget sm:mx-0 sm:my-[15px] widget-1">
                    ...
                    <p class="text-[#777777] mb-5">
                        We specialize in delivering top-notch civil construction services and equipment rental solutions,
            ...
            <div class="xl:w-3/12 lg:w-3/12 md:w-3/12 sm:w-6/12 flex-[0_0_auto] max-w-full px-[12px]">
                <div class="footer-widget sm:mx-0 sm:my-[15px] widget-2">
                    <h3 class="font-medium text-black capitalize relative text-[20px] mb-5 pb-5 after:content-[''] after:absolute after:w-20 after:h-1 after:left-0 after:bottom-0 after:bg-[#ffab00]">
                        <strong>popular</strong> links
                    </h3>
            ...
            <div class="xl:w-3/12 lg:w-3/12 md:w-3/12 sm:w-6/12 flex-[0_0_auto] max-w-full px-[12px]">
                <div class="footer-widget sm:mx-0 sm:my-[15px] widget-3">
                    <h3 class="font-medium text-black capitalize relative text-[20px] mb-5 pb-5 after:content-[''] after:absolute after:w-20 after:h-1 after:left-0 after:bottom-0 after:bg-[#ffab00]">
                        <strong>services</strong> offered
                    </h3>
            ...
            <!-- Contact Section -->
            <div class="xl:w-3/12 lg:w-3/12 md:w-3/12 sm:w-6/12 flex-[0_0_auto] max-w-full px-[12px]">
                <div class="footer-widget sm:mx-0 sm:my-[15px] widget-4">
                    <h3 class="font-medium text-black capitalize relative text-[20px] mb-5 pb-5 after:content-[''] after:absolute after:w-20 after:h-1 after:left-0 after:bottom-0 after:bg-[#ffab00]">
